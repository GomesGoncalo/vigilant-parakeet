...
async fn test_payload_encryption_prevents_inspection() {
    ...
    let _obu1 = Obu::new(args_obu1, Arc::new(tun_obu1), Arc::new(dev_obu1), "test_obu".to_string()).unwrap();
    let obu2 = Obu::new(args_obu2, Arc::new(tun_obu2), Arc::new(dev_obu2), "test_obu".to_string()).unwrap();
...
async fn test_encryption_disabled_allows_inspection() {
    ...
    let _rsu = Rsu::new(args_rsu, Arc::new(tun_rsu), Arc::new(dev_rsu), "test_rsu".to_string()).unwrap();
    let obu1 = Obu::new(args_obu1, Arc::new(tun_obu1), Arc::new(dev_obu1), "test_obu".to_string()).unwrap();
